...
func (pc *Req2K8sConvert) getK8sHostAlias(podReqHostAlias []pod_req.ListMapItem) []corev1.HostAlias {
...
func (pc *Req2K8sConvert) getK8sVolumeMount(podReqMounts []pod_req.VolumeMount) []corev1.VolumeMount {
